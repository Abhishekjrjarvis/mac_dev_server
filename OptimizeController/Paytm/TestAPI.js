...
// exports.initiateAdmission = async (req, res) => {
//   try {
//     const {
//       moduleId,
//       paidBy,
...
//                   : type === "Admission_Background_Update"
//       ? `${process.env.CALLBACK_URLS}/v2/paytm/callback/testing/url/internal`
...
// exports.callbackTesting = async (req, res) => {
//     try {
//         // const { moduleId, paidBy, name, paidTo, isApk, price } = req.params;
//         var paytmParams = {};
//         paytmParams.body = {
