...
const subjectSemesterAttendanceReport = async (
  datalist,
  subjectId,
  from,
  to
  ...
  let ot_name = `${subject_data?.subject?.subjectName}-Semester`;
  ...
  stream.on("finish", async () => {
    ...
    subject.export_collection.push({
      excel_type: "SUBJECT_SEMESTER_ATTENDANCE",
...
module.exports = subjectSemesterAttendanceReport;
