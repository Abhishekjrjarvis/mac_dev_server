...
exports.processApplicationPayment = async (req, res, next) => {
  ...
  params[
    "CALLBACK_URL"
  ] = `http://18.205.27.165/api/api/v1/application/callback/${uid}/apply/${aid}/ins/${iid}/finance/${fid}`;
        ...
        var post_req = https.request(options, function (post_res) {
          ...
          post_res.on("end", function () {
            ...
            if (status === "TXN_SUCCESS") {
              ...
              res.redirect(
                `http://18.205.27.165/user/${uid}/insjoinandapply/${iid}/application-apply/${aid}`
              );
            } else {
...
const userApplicationUpdated = async (
  ...
  try {
    ...
    institute.insBankBalance = institute.insBankBalance + parseInt(tx_apAmount);
    finance.financeBankBalance =
      finance.financeBankBalance + parseInt(tx_apAmount);
