            ...
            var obs = {}
              ...
              for(var cls of classes){
                ...
                for(var ref of all_student){
                  ...
                  // var all_remain = await RemainingList.find({ student: ref?._id })
                  total_fees += one_remain?.fee_structure?.total_admission_fees
                  total_collect += one_remain?.paid_fee + ref?.studentPaidFeeCount + one_remain?.paid_by_government
                  total_pending += one_remain?.fee_structure?.total_admission_fees - one_remain?.paid_fee + ref?.studentPaidFeeCount + one_remain?.paid_by_government
                  collect_by_student += (one_remain?.paid_fee >= one_remain?.fee_structure?.applicable_fees ? one_remain?.fee_structure?.applicable_fees : one_remain?.paid_fee)
                  pending_by_student += one_remain?.paid_fee <= one_remain?.fee_structure?.applicable_fees ? one_remain?.fee_structure?.applicable_fees - one_remain?.paid_fee : 0
                  collect_by_government += one_remain?.paid_by_government
                  pending_from_government += one_remain?.fee_structure?.total_admission_fees - one_remain?.fee_structure?.applicable_fees
                    ele.student.total_paid_fees += one_remain?.paid_fee
                  ele.student.total_os_fees += one_remain?.remaining_fee
                  ele.student.applicable_os_fees += one_remain?.fee_structure?.applicable_fees - one_remain?.paid_fee > 0
                  ? one_remain?.fee_structure?.applicable_fees - one_remain?.paid_fee
                  : 0
                  ele.student.government_os_fees += one_remain?.fee_structure?.total_admission_fees - one_remain?.fee_structure?.applicable_fees
                  if(one_remain?.fee_structure?.total_admission_fees + ref?.studentRemainingFeeCount > 0){
                    total_fees_arr.push(one_remain?.student)
                  }
                  if(one_remain?.paid_fee + ref?.studentPaidFeeCount + one_remain?.paid_by_government > 0){
                    total_collect_arr.push(one_remain?.student)
                  }
                  if(one_remain?.fee_structure?.total_admission_fees + ref?.studentRemainingFeeCount - one_remain?.paid_fee + ref?.studentPaidFeeCount + one_remain?.paid_by_government > 0){
                    total_pending_arr.push(one_remain?.student)
                  }
                  if(one_remain?.fee_structure?.applicable_fees > 0){
                    collect_by_student_arr.push(one_remain?.student)
                  }
                  if((one_remain?.paid_fee <= one_remain?.fee_structure?.applicable_fees ? one_remain?.fee_structure?.applicable_fees - one_remain?.paid_fee : 0) > 0){
                    pending_by_student_arr.push(one_remain?.student)
                  }
                  if(one_remain?.paid_by_government > 0){
                    collect_by_government_arr.push(one_remain?.student)
                  }
                  if(one_remain?.fee_structure?.total_admission_fees - one_remain?.fee_structure?.applicable_fees > 0){
                    pending_from_government_arr.push(one_remain?.student)
                  }
                  }
                  total_fees_arr = remove_duplicated(total_fees_arr)
                  total_collect_arr = remove_duplicated(total_collect_arr)
