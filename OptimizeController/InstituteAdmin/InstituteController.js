  ...
  try {
    ...
    if (search) {
      ...
      var studentIns = await Student.find({
        ...
        .sort({ createdAt: -1 })
        .select(
          "studentFirstName studentMiddleName studentLastName qviple_student_pay_id applicable_fees_pending studentGender studentCastCategory batches photoId studentProfilePhoto studentPhoneNumber studentGRNO studentROLLNO studentAdmissionDate admissionRemainFeeCount"
        )
        .populate({
          path: "user",
          select: "userLegalName userEmail userPhoneNumber",
  ...
  try {
    ...
    if (isApk) {
      var staff = await Staff.findById({ _id: id })
        .select(
          "staffFirstName staffDesignationCount staffMiddleName teaching_type staffJoinDate staffPanNumber experience staffDepartment staffClass staffSubject staffBatch staffLastName photoId staffProfilePhoto staffDOB staffGender staffNationality staffMotherName staffMTongue staffCast staffCastCategory staffReligion staffBirthPlace staffBirthPlacePincode staffBirthPlaceState staffBirthPlaceDistrict staffDistrict staffPincode staffState staffAddress staffCurrentPincode staffCurrentDistrict staffCurrentState staffCurrentAddress staffPhoneNumber staffAadharNumber staffQualification staffDocuments staffAadharFrontCard staffAadharBackCard staffPreviousSchool staffBankName staffBankAccount staffBankAccountHolderName staffBankIfsc staffBankPassbook staffCasteCertificatePhoto staffStatus staffROLLNO staffPhoneNumber casual_leave medical_leave sick_leave off_duty_leave c_off_leave lwp_leave staff_pf_number experience"
        )
        .populate({
          path: "user",
      ...
      var staff = await Staff.findById({ _id: id })
        .select(
          "staffFirstName staffDesignationCount staffMiddleName staffDepartment teaching_type staffJoinDate staffPanNumber staffClass staffSubject staffBatch staffLastName photoId staffProfilePhoto staffDOB staffGender staffNationality staffMotherName staffMTongue staffCast staffCastCategory staffReligion staffBirthPlace staffBirthPlacePincode staffBirthPlaceState staffBirthPlaceDistrict staffDistrict staffPincode staffState staffAddress staffCurrentPincode staffCurrentDistrict staffCurrentState staffCurrentAddress staffPhoneNumber staffAadharNumber staffQualification staffDocuments staffAadharFrontCard staffAadharBackCard staffPreviousSchool staffBankName staffBankAccount staffBankAccountHolderName staffBankIfsc staffBankPassbook staffCasteCertificatePhoto staffStatus staffROLLNO staffPhoneNumber casual_leave medical_leave sick_leave off_duty_leave c_off_leave lwp_leave staff_pf_number experience"
        )
        .populate({
          path: "user",
          select: "userLegalName userPhoneNumber userEmail",
