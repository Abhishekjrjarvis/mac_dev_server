...
exports.add_all_installment = async (arg1, arg2, arg3, amount, arg4) => {
  try {
    if (arg4?.hostel_fee_structure.two_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount:
          arg4?.hostel_fee_structure.one_installments.fees -
          amount +
          arg4?.hostel_fee_structure.two_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Second Installment",
        isEnable: true,
        dueDate: arg4?.hostel_fee_structure.two_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.three_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.three_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Third Installment",
        dueDate: arg4?.hostel_fee_structure.three_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.four_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.four_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Four Installment",
        dueDate: arg4?.hostel_fee_structure.four_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.five_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.five_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Five Installment",
        dueDate: arg4?.hostel_fee_structure.five_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.six_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.six_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Six Installment",
        dueDate: arg4?.hostel_fee_structure.six_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.seven_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.seven_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Seven Installment",
        dueDate: arg4?.hostel_fee_structure.seven_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.eight_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.eight_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Eight Installment",
        dueDate: arg4?.hostel_fee_structure.eight_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.nine_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.nine_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Nine Installment",
        dueDate: arg4?.hostel_fee_structure.nine_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.ten_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.ten_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Ten Installment",
        dueDate: arg4?.hostel_fee_structure.ten_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.eleven_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.eleven_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Eleven Installment",
        dueDate: arg4?.hostel_fee_structure.eleven_installments.dueDate,
      });
    }
    if (arg4?.hostel_fee_structure.tweleve_installments.fees > 0) {
      arg3.remaining_array.push({
        remainAmount: arg4?.hostel_fee_structure.tweleve_installments.fees,
        appId: arg1._id,
        status: "Not Paid",
        instituteId: arg2,
        installmentValue: "Tweleve Installment",
        dueDate: arg4?.hostel_fee_structure.tweleve_installments.dueDate,
      });
    }
    await arg3.save();
  } catch (e) {
  ...
  try {
    ...
    if (arg2.total_installments == "2") {
      ...
      if (
        ...
        arg5.hostelRemainFeeCount >= amount
      ) {
      }
    }
...
exports.add_total_installment = (student) => {
  try {
    ...
    total =
      ...
      student?.hostel_fee_structure?.two_installments?.fees +
      student?.hostel_fee_structure?.three_installments?.fees +
      student?.hostel_fee_structure?.four_installments?.fees +
      student?.hostel_fee_structure?.five_installments?.fees +
      student?.hostel_fee_structure?.six_installments?.fees +
      student?.hostel_fee_structure?.seven_installments?.fees +
      student?.hostel_fee_structure?.eight_installments?.fees +
      student?.hostel_fee_structure?.nine_installments?.fees +
      student?.hostel_fee_structure?.ten_installments?.fees +
      student?.hostel_fee_structure?.eleven_installments?.fees +
      student?.hostel_fee_structure?.tweleve_installments?.fees;
...
exports.exempt_installment = async (
  ...
  try {
    ...
    if (student_args?.hostelRemainFeeCount >= imagine_price) {
      student_args.hostelRemainFeeCount -= imagine_price;
    }
    student_args.hostelPaidFeeCount += imagine_price;
...
exports.set_fee_head_query = async (
  ...
  try {
    ...
    if (direct_args) {
      ...
      var parent_head = {
        ...student_args.hostel_fee_structure?.fees_heads,
        count: student_args.hostel_fee_structure?.fees_heads?.length,
      };
    }
      ...
      for (var i = 0; i < parent_head?.count; i++) {
        var one_master = await FeeMaster.findOne({
          $and: [
            ...
            { finance: student_args?.hostel_fee_structure?.finance },
          ],
        });
        if (one_master) {
          if (
        ...
        student_args.active_fee_heads.push({
          ...
          paid_fee:
            price_query >= parent_head[`${i}`]?.head_amount
              ? parent_head[`${i}`].head_amount
              : price_query,
          fee_structure: student_args?.hostel_fee_structure?._id,
...
exports.set_fee_head_query_redesign_hostel = async (
  student_args,
  price,
  apply_args,
  receipt_args
  ...
  try {
    ...
    if (exist_filter_student_heads?.length > 0) {
      ...
      for (var ref of exist_filter_student_heads) {
        if (
          `${ref?.fee_structure}` ===
          `${student_args?.hostel_fee_structure?._id}`
        ) {
          receipt_args.fee_heads.push({
            head_id: ref?._id,
            head_name: ref?.head_name,
