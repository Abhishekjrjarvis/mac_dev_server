...
const { processCreditPayment, paytmCreditResponse } = require('../controllers/creditPayment')
...
// =================== Credit Payment =========================
router.route('/payment/credit/process').post(processCreditPayment);
router.route('/callback/ins/:id/credit').post(paytmCreditResponse);
