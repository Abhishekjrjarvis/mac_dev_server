...
//   params[
//     "CALLBACK_URL"
//   ] = `http://34.201.132.26/api/api/v1/admission/callback/${uid}/apply/${aid}/ins/${iid}/finance/${fid}`;
...
//               res.redirect(`http://34.201.132.26/userdashboard/${uid}`);
//             } else {
...
//       institute.insBankBalance + parseInt(tx_adAmount);
